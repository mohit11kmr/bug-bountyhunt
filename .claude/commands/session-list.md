...
```
No sessions found. Start one with /load-program-h1 then /session-save <name>
```
...
- To start a new session: `/load-program-h1 <handle>` then audit, then `/session-save <name>`
